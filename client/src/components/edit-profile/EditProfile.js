...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    /*
// *** Below are some alternative ways for above code and some experimental ideas
  // *** outdated
    ...
    if (nextProps.profile.profile) {
      ...
      Object.keys(profile).map((key, index) => {
        ...
        if (typeof profile[key] === "object") {
          Object.keys(profile[key]).map((key2, index2) => {
            profile[key2] = !isEmpty(profile[key][key2])
              ? profile[key][key2]
              : "";
          });
          delete profile[key];
      ...
      // Set component fields fields state
      this.setState({
        ...profile
      });
    }
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <SelectListGroup
                  ...
                  options={options}
                  error={errors.status}
                  info="Give us an idea of your career thus far"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
                  ...
                  info="Either your own company or one you've worked for"
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
